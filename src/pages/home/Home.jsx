...
const Home = () => {
    const [expandedCategories, setExpandedCategories] = useState(
        new Set([0, 1, 2, 3, 4, 5, 6]) // All categories expanded by default
    );
    ...
    const categorizedFeatures = [
        {
            ...
            features: [
                ...
                },
                {
                    ...
                    icon: <FaRocket />,
                    description: "Improve animations and transitions using hardware acceleration.",
                    color: "#f43f5e",
                    comingSoon: true
                },
                {
                    ...
                    icon: <FaImages />,
                    description: "Create smooth page transitions with minimal re-rendering.",
                    color: "#6d28d9",
                    comingSoon: true
                },
                {
                        ...
                        <div key={index} className="category-section">
                            ...
                            <AnimatePresence>
                                {isExpanded && (
                                    ...
                                    >
                                        {categoryGroup.features.map((item) => (
